...
<div class="container mt-4">
  <div class="row mt-3">
    <div class="col hvr-float">
      <div class="display-4 text-center" id="perrito">
  ...
  <div class="row mt-3">
    ...
    <div class="col-sm-4">
      ...
      <div class="card border-0" style="width: 18rem;">
        <img class="card-img-top animate__animated animate__bounce" src="img/logo.png" alt="Card image cap"> <!--jalo bien para la imagen-->
        <div class="card-body">
