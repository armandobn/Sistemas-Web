  ...
  <div class="row justify-content-around py-4">
    <div class="col-sm-5 mt-1">
      ...
      <form id="formulario_registro_a">
        ...
        <div class="form-group">
          <label for="registro_telefono" class="lead">Teléfono de Contacto(Preferente Movil)</label>
          <input 
            type="number"
            class="form-control form-control-sm"
        ...
        <div class="form-group">
          ...
          <select name="registro_carrera" id="registro_carrera" class="form-control form-control-sm">
            ...
            <option value="GES" class="lead">Ingenieria en Gestion Empresarial</option>
            <option value="IND" class="lead">Ingenieria Industrial</option>
            <option value="SIS" class="lead">Ingeniaria en Sistemas Computacionales</option>
          </select>
        </div>
      </form>
    </div>
